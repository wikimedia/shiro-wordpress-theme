<?php
/**
 * Title: Header Light Temp
 * Slug: shiro/header-light-temp
 * Description: Header with nav, search, language, and donate button
 * Categories: header
...
<!-- wp:navigation {"ref":77571,"overlayMenu":"always","align":"wide","className":"primary-nav mobile-nav","layout":{"type":"flex","justifyContent":"center"}} /-->

<!-- wp:search {"label":"Search","showLabel":false,"placeholder":"Search site","buttonText":"Search","buttonPosition":"no-button","buttonUseIcon":true,"className":"desktop-nav"} /-->
...
<!-- wp:group {"metadata":{"name":"Header"},"align":"full","className":"site-header desktop-nav","style":{"elements":{"link":{"color":{"text":"var:preset|color|main"}}},"border":{"bottom":{"color":"var:preset|color|border-light","width":"1px"},"top":[],"right":[],"left":[]},"position":{"type":""},"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"0","bottom":"0"}}},"backgroundColor":"base","layout":{"inherit":true,"type":"constrained"}} -->
<div class="wp-block-group alignfull site-header desktop-nav has-base-background-color has-background has-link-color" style="border-bottom-color:var(--wp--preset--color--border-light);border-bottom-width:1px;margin-top:0;margin-bottom:0;padding-top:0;padding-bottom:0"><!-- wp:group {"align":"wide","className":"site-header\u002d\u002dinner","style":{"spacing":{"blockGap":"var:preset|spacing|16"}},"layout":{"type":"flex","justifyContent":"space-between"}} -->
<div class="wp-block-group alignwide site-header--inner"><!-- wp:navigation {"ref":77551,"overlayMenu":"never","align":"wide","className":"primary-nav","layout":{"type":"flex","justifyContent":"center"}} /--></div>
<!-- /wp:group --></div>
<!-- /wp:group -->
