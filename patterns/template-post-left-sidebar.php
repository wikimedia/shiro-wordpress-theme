 ...
 * Slug: shiro/template-post-left-sidebar
...
<div class="wp-block-columns alignwide" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:column {"width":"33.33%","className":"shiro-hide-on-mobile"} -->
<div class="wp-block-column shiro-hide-on-mobile" style="flex-basis:33.33%"></div>
<!-- /wp:column -->
