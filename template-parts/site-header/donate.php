...
$uri     = get_theme_mod( 'wmf_donate_now_uri', 'https://donate.wikimedia.org/?wmf_medium=wmfSite&wmf_campaign=comms' );
$copy    = get_theme_mod( 'wmf_donate_now_copy', __( 'Donate', 'shiro-admin' ) );
?>

<div class="nav-donate">
	<a href="<?php echo esc_url( $uri ); ?>&wmf_source=<?php echo esc_attr( $page_id ); ?>" class="nav-donate__link">
