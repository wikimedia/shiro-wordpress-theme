...
class Footer extends Base {
	 ...
	 *
	 * @param string $setting Key for selected text to display.
	 *
	 * @return string
	 */
	public static function defaults( string $setting = '' ): string {
		$defaults = array(
			...
			'wmf_footer_copyright'               => __(
				'This work is licensed under a <a href="https://creativecommons.org/licenses/by/3.0/">Creative Commons Attribution 3.0</a> unported license. Some images under <a href="https://creativecommons.org/licenses/by-sa/2.0/">CC BY-SA</a>.',
				'shiro-admin' 
			),
		);
