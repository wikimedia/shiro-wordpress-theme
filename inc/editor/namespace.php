...
function add_theme_supports() {
	...
	add_theme_support( 'editor-color-palette', [
		...
		[ 'name' => __( 'Blue', 'shiro-admin' ),             'slug' => 'blue',   'color' => '#0063bf' ],
		[ 'name' => __( 'Blue AAA', 'shiro-admin' ),         'slug' => 'blue-aaa',   'color' => '#0C57A8' ],
		[ 'name' => __( 'Blue 50', 'shiro-admin' ),          'slug' => 'blue50',   'color' => '#3a25ff' ],
		[ 'name' => __( 'Blue 70', 'shiro-admin' ),          'slug' => 'blue70',   'color' => '#c3d8ef' ],
		[ 'name' => __( 'Bright Blue', 'shiro-admin' ),      'slug' => 'bright-blue',   'color' => '#049dff' ],
		[ 'name' => __( 'Bright Blue 70', 'shiro-admin' ),   'slug' => 'bright-blue-70',   'color' => '#c0e6ff' ],
		[ 'name' => __( 'Dark Green', 'shiro-admin' ),       'slug' => 'dark-green',   'color' => '#305d70' ],
		[ 'name' => __( 'Dark Green 70', 'shiro-admin' ),    'slug' => 'dark-green-70',   'color' => '#cbd6db' ],
		[ 'name' => __( 'Blue 90', 'shiro-admin' ),          'slug' => 'blue90',   'color' => '#eeeaff' ],
		[ 'name' => __( 'Green AAA', 'shiro-admin' ),        'slug' => 'green-aaa', 'color' => '#246342' ],
		[ 'name' => __( 'Green', 'shiro-admin' ),            'slug' => 'green',    'color' => '#339966' ],
		[ 'name' => __( 'Green 70', 'shiro-admin' ),         'slug' => 'green70',    'color' => '#cbe0d5' ],
		[ 'name' => __( 'Bright Green', 'shiro-admin' ),     'slug' => 'bright-green',    'color' => '#71d1b3' ],
		[ 'name' => __( 'Bright Green 70', 'shiro-admin' ),  'slug' => 'bright-green70',    'color' => '#dbf3ec' ],
		[ 'name' => __( 'Orange', 'shiro-admin' ),           'slug' => 'orange', 'color' => '#ee8019' ],
		[ 'name' => __( 'Orange 70', 'shiro-admin' ),        'slug' => 'orange70', 'color' => '#fbdfc5' ],
		[ 'name' => __( 'Pink', 'shiro-admin' ),             'slug' => 'pink', 'color' => '#e679a6' ],
		[ 'name' => __( 'Pink 70', 'shiro-admin' ),          'slug' => 'pink70', 'color' => '#f9dde9' ],
		[ 'name' => __( 'Purple', 'shiro-admin' ),           'slug' => 'purple', 'color' => '#5748b5' ],
		[ 'name' => __( 'Purple 70', 'shiro-admin' ),        'slug' => 'purple70', 'color' => '#d5d1ec' ],
		[ 'name' => __( 'Red', 'shiro-admin' ),              'slug' => 'red',    'color' => '#900' ],
		[ 'name' => __( 'Red AAA', 'shiro-admin' ),          'slug' => 'red-aaa',    'color' => '#970302' ],
		[ 'name' => __( 'Red 50', 'shiro-admin' ),           'slug' => 'red50',    'color' => '#d40356' ],
		[ 'name' => __( 'Red 90', 'shiro-admin' ),           'slug' => 'red90',    'color' => '#fbe9f1' ],
		[ 'name' => __( 'Yellow', 'shiro-admin' ),           'slug' => 'yellow', 'color' => '#f0bc00' ],
		[ 'name' => __( 'Yellow 50', 'shiro-admin' ),        'slug' => 'yellow50', 'color' => '#fffd33' ],
		[ 'name' => __( 'Yellow 70', 'shiro-admin' ),        'slug' => 'yellow70', 'color' => '#fbeebf' ],
		[ 'name' => __( 'Yellow 90', 'shiro-admin' ),        'slug' => 'yellow90', 'color' => '#fef6e7' ],
		[ 'name' => __( 'Bright Yellow', 'shiro-admin' ),    'slug' => 'bright-yellow', 'color' => '#e9e7c4' ],
		[ 'name' => __( 'Bright Yellow 70', 'shiro-admin' ), 'slug' => 'bright-yellow-70', 'color' => '#f9f9f0' ],
